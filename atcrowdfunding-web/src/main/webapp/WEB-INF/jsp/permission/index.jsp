...
<script type="text/javascript">
            ...
            view: {
                ...
                addHoverDom: function (treeId, treeNode) {
                    ...
                    if (treeNode.level === 0) {
                        ...
                        s += '<a class="btn btn-info dropdown-toggle btn-xs" onclick="editNode(' + treeNode.id + ')" style="margin-left:10px;padding-top:0;"  href="#" title="修改权限信息">&nbsp;&nbsp;<i class="fa fa-fw fa-edit rbg "></i></a>';
                        if (treeNode.children.length === 0) {
                            s += '<a class="btn btn-info dropdown-toggle btn-xs" onclick="deleteNode(' + treeNode.id + ',\'' + treeNode.name + '\')" style="margin-left:10px;padding-top:0;" href="#" >&nbsp;&nbsp;<i class="fa fa-fw fa-times rbg "></i></a>';
                        }
                        s += '<a class="btn btn-info dropdown-toggle btn-xs" onclick="addNode(' + treeNode.id + ')" style="margin-left:10px;padding-top:0;" href="#" >&nbsp;&nbsp;<i class="fa fa-fw fa-plus rbg "></i></a>';
    ...
    function deleteNode(id, permissionname) {
        var index = null;
        layer.confirm("确定删除节点【" + permissionname + "】？", {icon: 3, title: '提示'}, function (cindex) {
            $.ajax({
                type: "POST",
                ...
                success: function (result) {
                    layer.close(index);
                    if (result.success) {
                        layer.msg('节点删除成功！', {icon: 6, time: 1000}, function () {
                            var treeObj = $.fn.zTree.getZTreeObj("permissionTree");
                            treeObj.reAsyncChildNodes(null, "refresh");
                        });
                    } else {
                        layer.msg('节点删除失败，请重新操作！', {icon: 5, time: 2000, anim: 6}, function () {
                        });
                    }
                }
            });
