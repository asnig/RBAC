        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form id="roleForm" role="form" class="form-inline" method="post">
                        <input type="hidden" name="userid" value="${user.id}"/>
                        <div class="form-group">
                            <label for="leftSel">未分配角色列表</label><br>
                            <select id="leftSel" name="unassignRoleids" class="form-control" multiple size="10"
                        ...
                        <div class="form-group" style="margin-left:40px;">
                            <label for="rightSel">已分配角色列表</label><br>
                            <select id="rightSel" name="assignRoleids" class="form-control" multiple size="10"
                                    style="width:200px;overflow-y:auto;">
...
<script type="text/javascript">
    $(function () {
        ...
        $("#left2RightBtn").click(function () {
            var opts = $("#leftSel :selected");
            if (opts.length === 0) {
                layer.msg('请选择需要分配的角色！', {icon: 5, time: 2000, anim: 6}, function () {
                });
            } else {
                $.ajax({
                    type: "POST",
                    ...
                    success: function (result) {
                        $("#rightSel").append(opts);
                        if (result.success) {
                            layer.msg('分配角色成功！', {icon: 6, time: 2000}, function () {
                            });
                        } else {
                            layer.msg('分配角色失败！', {icon: 5, time: 2000, anim: 6}, function () {
                            });
                        }
                    }
        ...
        $("#right2LeftBtn").click(function () {
            var opts = $("#rightSel :selected");
            if (opts.length === 0) {
                layer.msg('请选择需要取消分配的角色！', {icon: 5, time: 2000, anim: 6}, function () {
                });
            } else {
                $.ajax({
                    type: "POST",
                    ...
                    success: function (result) {
                        $("#leftSel").append(opts);
                        if (result.success) {
                            layer.msg('取消分配角色成功！', {icon: 6, time: 2000}, function () {
                            });
                        } else {
                            layer.msg('取消分配角色失败！', {icon: 5, time: 2000, anim: 6}, function () {
                            });
                        }
                    }
